package com.training.assignment;
	...
	public class Employee {	
			...
			public Object calculate() {
				...
				double pf = 2.1*this.empSalary;
			
				double allowance = 3.5*this.empSalary;
			...
			public static void main(String[] args) {
				...
				allValues.put("empId","30303");
				allValues.put("empName","priya");
				allValues.put("empDept", "Devlop");
				allValues.put("empSalary",50000.0);
